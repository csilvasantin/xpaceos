import {openMatrixView,closeMatrixView,subscribeMatrixView} from './matrix-preview-ui.mjs?v=px-1';
import {openLifeView,closeLifeView,subscribeLifeView} from './life-ui.mjs?v=px-1';
import {openBestView,closeBestView,subscribeBestView} from './best-preview-ui.mjs?v=px-1';
