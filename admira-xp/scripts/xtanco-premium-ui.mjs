import {openLifeView,closeLifeView,subscribeLifeView} from './life-ui.mjs?v=tiers-live-9';
import {openBestView,closeBestView,subscribeBestView} from './best-preview-ui.mjs?v=tiers-live-9';
import {openGoodView,closeGoodView,subscribeGoodView} from './good-preview-ui.mjs?v=tiers-live-9';
import {createVisualTiers,requestedTier} from './xtanco-visual-tiers.mjs?v=tiers-live-9';
import {createTierControls,updateTierControls} from './visual-tier-controls.mjs?v=tiers-live-9';
...
const tiers=createVisualTiers({openGood:openGoodView,closeGood:closeGoodView,subscribeGood:subscribeGoodView,openBetter:openLifeView,closeBetter:closeLifeView,subscribeBetter:subscribeLifeView,
