...
export function createTierControls({context='Calidad visual',choose}={}){
  ...
  element.innerHTML='<button type="button" data-visual-mode="good" title="01.- Good · estilo 8-bit · gemelo clásico"><span>01.- Good</span><small>8 bits</small></button><button type="button" data-visual-mode="better" title="02.- Better · estilo 16-bit · mismo gemelo en 3D"><span>02.- Better</span><small>16 bits</small></button><button type="button" data-visual-mode="best" title="03.- Best · estilo 32-bit · tienda y personas en 3D en vivo"><span>03.- Best</span><small>32 bits · 3D en vivo</small></button><button type="button" data-visual-mode="matrix" title="04.- Matrix · Avenida Admira · escena fija con visitantes en vivo"><span>04.- Matrix</span><small>Avenida Admira</small></button>';
