...
test('selector boots safely with denied storage or stale legacy Best and never imports the retired controller',()=>{
  ...
  assert.deepEqual(imports,['./life-ui.mjs?v=tiers-live-7','./best-preview-ui.mjs?v=tiers-live-7','./xtanco-visual-tiers.mjs?v=tiers-live-7','./visual-tier-controls.mjs?v=tiers-live-7']);
