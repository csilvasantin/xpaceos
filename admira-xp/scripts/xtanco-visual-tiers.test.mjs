...
test('selector boots safely with denied storage or stale legacy Best and never imports the retired controller',()=>{
  ...
  assert.deepEqual(imports,['./life-ui.mjs?v=blender-1','./best-preview-ui.mjs?v=blender-1','./xtanco-visual-tiers.mjs?v=inventari-1','./visual-tier-controls.mjs?v=inventari-1']);
