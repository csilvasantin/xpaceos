...
test('selector boots safely with denied storage or stale legacy Best and never imports the retired controller',()=>{
  ...
  assert.deepEqual(imports,['./matrix-preview-ui.mjs?v=visitors-24','./life-ui.mjs?v=visitors-24','./best-preview-ui.mjs?v=visitors-24','./xtanco-visual-tiers.mjs?v=matrix-furniture-1','./visual-tier-controls.mjs?v=matrix-furniture-1']);
