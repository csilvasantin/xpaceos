...
La preview con personas usa `../assets/best-xtanco-avenida-admira-cleanplate-20260915.png`, derivada de la imagen anterior eliminando el marco de puerta y sustituyendo la placa por «AVENIDA ADMIRA». `best-live-people.mjs` proyecta la cuadrícula canónica 14×8 de Good sobre cuatro anclas medidas en ese mismo suelo, consume el mapa real de dureza expuesto por el gemelo y añade huellas/oclusiones calibradas para el mobiliario fotográfico; no modifica la simulación. Los adultos y los niños tienen recortes fotográficos propios, con variación determinista de escala y corrección de profundidad.
