...
import {createBestPeopleLayer} from './best-live-people.mjs?v=tiers-live-5';
...
export function openBestView(options={}){
  ...
  dialog.innerHTML=`<header class="best-header"><div><p class="best-eyebrow">XPACEOS · 03.- BEST · 32 BITS</p><h1 id="best-title">El mismo Xtanco. El siguiente nivel.</h1></div><button type="button" class="best-close" aria-label="Volver a Good">Volver a Good ↗</button></header>
    ...
    <figure class="best-stage"><div class="best-live-scene"><img class="best-reference" src="assets/best-xtanco-cleanplate-20260915.png" alt="Referencia hiperrealista del Xtanco sin personas fijas, preparada para mostrar encima los personajes de la simulación."></div><figcaption>PERSONAS EN VIVO · ESCENARIO CONCEPTUAL</figcaption><p class="best-image-error" role="alert" hidden>No se ha podido cargar la referencia. Puedes volver a Good o Better desde el selector.</p></figure>
    <footer class="best-footer"><p><b>Mismo espacio de referencia · personas sincronizadas con la simulación.</b> El escenario y el mobiliario siguen siendo una imagen conceptual; los clientes superpuestos sí leen sus posiciones del Xtanco.</p><a href="assets/best-xtanco-concept-20260915.png" target="_blank" rel="noopener">Ver propuesta original ↗</a><a href="/help/funcionalidades/" target="_blank" rel="noopener">01–30 · Funcionalidades ↗</a><small>8 / 16 / 32 bits son niveles de estilo visual, no profundidad de color.</small></footer>`;
