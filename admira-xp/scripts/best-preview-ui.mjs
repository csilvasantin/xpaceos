...
export function openBestView(options={}){
  ...
  dialog.innerHTML=`<header class="best-header"><div><p class="best-eyebrow">XPACEOS · 03.- BEST · 32 BITS</p><h1 id="best-title">El mismo Xtanco. El siguiente nivel.</h1></div><button type="button" class="best-close" aria-label="Volver a Good">Volver a Good ↗</button></header>
    ...
    <figure class="best-stage"><div class="best-live-scene"><img class="best-reference" src="assets/best-xtanco-gran-de-gracia-cleanplate-20260915.png" alt="Referencia hiperrealista del Xtanco en Gran de Gràcia, con fachada barcelonesa y sin personas fijas, preparada para mostrar los personajes de la simulación."></div><figcaption>PERSONAS EN VIVO · CARRER GRAN DE GRÀCIA</figcaption><p class="best-image-error" role="alert" hidden>No se ha podido cargar la referencia. Puedes volver a Good o Better desde el selector.</p></figure>
